...
/*
 * 当阅读一个记录时, 检查当前记录的给定字段是否符合规则
 * when read a record, check current field of given table if match the rule
 */
    ...
    private function errMessage($activeTableName, $activeField, $currentFieldValue, $targetValue, $responseTableName, $checkOperation)
    {
        ...
        <div class="alert alert-danger">
			<strong>
				...
				Whoops! You can not read this record from data table : "$responseTableName"
			</strong>
