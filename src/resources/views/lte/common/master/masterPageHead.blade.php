<header class="main-header">
    ...
    <a href="#" class="logo">
        ...
        <span class="logo-mini"><b>UMI</b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>UMI</b>Admin</span>
    </a>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown notifications-menu">
                    ...
                    <ul class="dropdown-menu">
                        <li class="header">{{trans('umiTrans::master.chooseLanguage')}}</li>
                        <li>
                        ...
                        <li>
                            ...
                            <ul class="menu">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="{{$path}}/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                                        </div>
                                        <h4>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="{{$path}}/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                                        </div>
                                        <h4>
                                            Developers
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="{{$refresh}}" class="btn btn-default btn-flat">
